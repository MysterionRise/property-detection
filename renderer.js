...
const propertiesByQuestions = {
    0: ["Склизский", "Гладкий", "Шершавый", "Толстая кожура", "Имеет шипы", "Полосатый", "Крупные семена"],
    1: ["Колючий", "Желтая мякоть", "Крупные семена", "Гладкий", "Пористый", "Зернистый", "Маленькие семечки"],
    2: ["Чешуйчатый", "Склизский", "Тонкая кожура", "Рассыпчатый", "Ворсистый", "Шершавый", "Бугристый"],
    3: ["Пятнистый", "Мохнатый", "Бугристый", "Мягкий", "Сморщенный", "Белая мякость", "Ребристый"],
    4: ["Темно-коричневая мякоть", "В крапинку", "Шершавый", "Имеет шипы", "Полый внутри", "Тонкая кожура", "Гладкий"],
    5: ["Бархатистый", "Полосатый", "Красная мякоть", "Гладкий", "Скрученный", "Колючий", "Чешуйчатый"],
    6: ["Имеет дольки", "Пятнистый", "Толстая кожура", "Бугристый", "Бело-голубая мякоть", "Черные косточки", "Тонкая кожура"],
    7: ["Колючий", "Тонкая кожура", "Гладкий", "Коричневые семена", "Мохнатый", "Ребристый", "Мякоть в форме икринок"],
}
